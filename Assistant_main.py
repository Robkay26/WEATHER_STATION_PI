...
def main():
    ...
    display.draw_black.text(
        (10, 8), "Updated Time", fill=0, font=font8
    )

    ###################################################################################################################
    # CURRENT WEATHER
    display.draw_black.text((225, 150), "Dublin", fill=0, font=font16)
    ...
    display.draw_black.text((420, 10), "Rob and Niamh - Malta 2024", fill=0, font=font24)
    display.draw_image(430, 50, 290, 290, "nb")
    #for i in range(5):
