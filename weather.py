...
class Weather:
    def __init__(self, latitude, longitude, api_id):
        ...
        self.data = requests.get(
            "https://api.openweathermap.org/data/3.0/onecall?lat=53.303&lon=-6.257&appid=a29d0a87354a941571a2d729603aecfe").json()
    ...
    def update(self):
        self.data = requests.get(
            f"https://api.openweathermap.org/data/3.0/onecall?lat=53.303&lon=-6.257&appid=a29d0a87354a941571a2d729603aecfe").json()
        return self.data
